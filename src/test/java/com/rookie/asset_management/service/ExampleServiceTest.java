...
/**
 * This class is a placeholder for the ExampleServiceTest. This should not a public class, use the
 * default instead. The test class should be an annotated with
