...
public class AssetController {
    ...
    /**
     * Handles HTTP PUT request to update an existing asset by its ID.
     * Only unassigned assets can be edited. The editable fields include:
     * - name
     * - specification
     * - installed date
     * - state
     *
     * <p>The asset name must be unique within the same location.
