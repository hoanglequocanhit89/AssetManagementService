...
public class AssetServiceImpl implements AssetService {
     ...
     * <p>
     * Only allows updating the following fields: name, specification, installed date, and state.
     * Category is not allowed to be changed. The asset name must be unique within the user's location.
     * </p>
     *
    ...
    public EditAssetDtoResponse editAsset(Integer assetId, EditAssetDtoRequest dto, String username) {
        ...
        if (dto.getState() == null
                ...
                || dto.getState() == AssetStatus.WAITING_FOR_RECYCLING
