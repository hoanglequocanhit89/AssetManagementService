 ...
 * This interface extends BaseService to provide basic CRUD operations.
 */
public interface UserService {
   ...
   */
  PagingDtoResponse<UserDtoResponse> getAllUsers(UserFilterRequest userFilterRequest, int page, int size, String sortBy, String sortDir);
